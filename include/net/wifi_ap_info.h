...
#ifndef WIFI_AP_INFO_H
#define WIFI_AP_INFO_H
...
#if !defined(WIFI_AP_INFO_MAX_COUNT)
#define WIFI_AP_INFO_MAX_COUNT		8U
#endif

#if !defined(WIFI_PSK_MAX_LEN)
#define WIFI_PSK_MAX_LEN		32U
#endif
