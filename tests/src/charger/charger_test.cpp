...
TEST(Charger, ShouldAttachConnector) {
	struct connector *c = (struct connector *)0x1234;
	int id;
...
TEST(Charger, ShouldReturnCountOfConnectors_WhenConnectorAttached) {
	struct connector *c1 = (struct connector *)1;
	struct connector *c2 = (struct connector *)2;
	struct connector *c3 = (struct connector *)3;
