...
enum {
	PowerMetricInterruptCount,
	PowerMetricRingBufferOverflowCount,
	PowerMetricDebounceCount,
	PowerMetricNoPulseCount,
	PowerMetricSamplingMissCount,
	PowerMetricMax,
};
